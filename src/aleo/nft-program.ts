export const NFTProgramId = 'You_are_winning.aleo';

export const NFTProgram = `program You_are_winning.aleo;
...
function initialize_collection:
    ...
    assert.eq self.caller aleo1xd0wn3v32feywqyr2zuypycf7jmf25m0uy8v2unw9qectvjxgsfq7p4g2e;
    async initialize_collection r0 r1 r2 into r3;
    output r3 as You_are_winning.aleo/initialize_collection.future;
...
function add_nft:
    ...
    output r4 as You_are_winning.aleo/add_nft.future;
...
function add_minter:
    ...
    output r3 as You_are_winning.aleo/add_minter.future;
...
function update_toggle_settings:
    ...
    output r1 as You_are_winning.aleo/update_toggle_settings.future;
...
function set_mint_block:
    ...
    output r1 as You_are_winning.aleo/set_mint_block.future;
...
function update_symbol:
    ...
    output r1 as You_are_winning.aleo/update_symbol.future;
...
function update_base_uri:
    ...
    output r1 as You_are_winning.aleo/update_base_uri.future;
...
function open_mint:
    ...
    output r4 as You_are_winning.aleo/open_mint.future;
...
function mint:
    ...
    output r7 as You_are_winning.aleo/mint.future;
...
function claim_nft:
    ...
    output r6 as You_are_winning.aleo/claim_nft.future;
...
function authorize:
    ...
    output r2 as You_are_winning.aleo/authorize.future;
...
function transfer_public:
    ...
    output r5 as You_are_winning.aleo/transfer_public.future;
...
function convert_private_to_public:
    ...
    output r3 as You_are_winning.aleo/convert_private_to_public.future;
...
function convert_public_to_private:
    ...
    output r5 as NFT.record;
    output r6 as You_are_winning.aleo/convert_public_to_private.future;
